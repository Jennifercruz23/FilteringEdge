...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting Filtering processing");
    
    let mut processor = FilteringProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = FilteringProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = FilteringProcessor::new(false);
